...
const login = () => {
  const loginHandle = ()=> {
    ...
    //firebase authenticaton goes here
    ...
    <div class="h-full">
      <div
        ...
        <div
          ...
          <img
            src="https://o.remove.bg/downloads/fed2e16e-7922-4c9c-91e4-fb248b55eb7b/Untitled_design-removebg-preview.png"
            class="w-full"
            alt="Sample image" />
        </div>
        ...
        <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
          <form>
            ...
            <div class="mb-6 flex items-center justify-between">
              ...
              <a href="#" className='text-red-400 mx-3'>Forgot password?</a>
            </div>
